...
### Article
- [AWS Simple Queue Service (SQS) 101 with a demo using AWS CLI](https://dev.to/aws-builders/aws-simple-queue-service-sqs-101-with-a-demo-using-aws-cli-32dc)
- [Amazon Web Services – Introduction to Simple Queue Service(SQS)](https://www.geeksforgeeks.org/aws-sqs/)
